(function() {
    ...
    const injectStyles = () => {
        ...
        s.innerHTML = `
            ...
            /* MODAL OVERLAY STAYS AT MAX Z-INDEX */
            ...
            @media (max-width: 768px) { 
                ...
                /* MOVED HIGHER (120px) TO CLEAR STICKY MOBILE CARTS */
            ...
            /* CLEAN, PREMIUM DARK BRANDING (NO RAINBOW) */
            .v-brand-logo { font-size:12px; font-weight:800; letter-spacing:1px; margin-bottom:15px; text-transform:uppercase; color: #333; display: inline-block; }
            ...
            /* Z-INDEX DROPPED TO 999 SO SIDE CARTS SLIDE OVER IT */
    ...
    const checkPage = () => {
        // 1. Read the hidden HTML code of the entire page
        const backgroundCode = document.documentElement.innerHTML.toLowerCase();
        
        // 2. Read the actual URL at the top of the browser
        const fullUrl = window.location.href.toLowerCase();
        
        // 3. If "vton" is in the code OR in the URL, trigger it!
