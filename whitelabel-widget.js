(function() {
    ...
    // THE NEW "X-RAY" SHOPIFY TAG SCANNER
    const checkPage = () => {
        // Reads the hidden HTML code generated by Shopify
        const backgroundCode = document.documentElement.innerHTML.toLowerCase();
        
        // Checks if the Shopify owner added "vton" as a tag or text
        const hasVtonTag = backgroundCode.includes('vton');
